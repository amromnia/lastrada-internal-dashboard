...
export function BookingConfirmation({ newBookingData, onClose }: BookingConfirmationProps) {
  return (
    <div className="space-y-6 py-4">
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">Your booking has been submitted and is pending approval.</p>
        </div>
      </div>
